...
$thequerystring = "INSERT INTO 2456604 (Latitude, Longitude, Description, 'Safety Equip', 'Road Class', 'Crash Type', 'Age of Cyclist', 'Acc Time', 'Traffic Control', 'Road Surface', 'Year') VALUES ('" . $theLat . "', '" . $theLon . "', '" . $theDesc . "', '" . $theSafe . "', '" . $theRoad . "', '" . $theCras . "', '" . $theAgeo . "', '" . $theAcct . "', '" . $theTraf . "', '" . $theRoads . "', '" . $theYear . "')";
