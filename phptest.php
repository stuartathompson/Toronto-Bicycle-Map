...
$theKey = $_GET['ID'];
$theGeom = $_GET['geometry'];
$theMethod = $_GET['method'];
echo $theMethod;
echo $theKey;
echo $theGeom;
if($theMethod == 'save'){
	$thequerystring = "INSERT INTO 2701925 ('geometry','ID') VALUES ('" . $theGeom . "', '" . $theKey ."')";
} else {
	$thequerystring = "UPDATE 2701925 SET 'geometry' = '" . $theGeom . "' WHERE 'ID' = '" . $theKey ."'";
}
echo $thequerystring;
